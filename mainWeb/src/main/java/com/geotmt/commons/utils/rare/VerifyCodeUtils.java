package com.geotmt.commons.utils.rare;
...
public class VerifyCodeUtils {
    ...
    public static final String VERIFY_CODES = "2345678910";
    ...
    public static String generateVerifyCode(int verifySize, String sources) {
        ...
        // System.out.println(verifyCode.toString()+"-----11");
     ...
     * @return byte[]
     */
    public static byte[] outputImage(int w, int h, OutputStream os, String code)
            throws IOException {
