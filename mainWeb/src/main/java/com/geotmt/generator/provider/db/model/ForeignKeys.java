...
import com.geotmt.generator.util.ListHashtable;
...
public class ForeignKeys  {
	...
	protected ListHashtable foreignKeys;
	/**
	...
	public ListHashtable getForeignKeys() {
	return foreignKeys;
}
    public void setForeignKeys(ListHashtable foreignKeys) {
