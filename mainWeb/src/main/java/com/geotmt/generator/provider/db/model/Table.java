...
public class Table {
	...
	List forenignKeyColumns = new ArrayList();
	...
	public String getViewPKColumnID() {
		return viewPKColumnID;
	}
	public void setViewPKColumnID(String viewPKColumnID) {
		this.viewPKColumnID = viewPKColumnID;
	}
}
